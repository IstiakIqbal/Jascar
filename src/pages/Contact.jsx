  ...
  return (
    <section className="" id="contact">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-28 sm:px-6 lg:px-8 lg:pb-16">
        ...
        <div data-aos="zoom-in" className="flex items-stretch justify-center">
                  ...
                  <div className="mx-0 mb-1 sm:mb-4">
                    <div className="mx-0 mb-1 sm:mb-4">
                      ...
                      <input
                        ...
                        className="mb-2 w-full rounded-md border border-gray-300 py-2 pl-2 pr-4 shadow-md sm:mb-0"
                        name="name"
                      />
                    </div>
                    <div className="mx-0 mb-1 sm:mb-4">
