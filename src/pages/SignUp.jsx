              ...
              <div className="max-w-sm mx-auto">
                ...
                <form>
                  <div className="flex flex-wrap -mx-3 mb-3">
                    <div className="w-full px-3">
                      <button className="btn rounded-none px-0 text-white bg-gray-900 hover:bg-gray-800 w-full relative flex items-center">
                        <svg
                  ...
                  <div className="flex flex-wrap -mx-3">
                    <div className="w-full px-3">
                      <button className="btn rounded-none px-0 text-white bg-blue-600 hover:bg-blue-700 w-full relative flex items-center">
                        <svg
                          className="w-4 h-4 fill-current text-white opacity-75 flex-shrink-0 mx-4"
                          viewBox="0 0 16 16"
                          xmlns="http://www.w3.org/2000/svg"
