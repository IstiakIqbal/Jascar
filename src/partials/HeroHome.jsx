        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                Discover unparalleled automotive care with Jasar Al Heera – where passion meets precision, and your satisfaction is our priority.
              </p>
              <div
              ...
              >
                ...
                <div>
                  <a
                    className="btn rounded-none text-white bg-gray-900 hover:bg-gray-800 w-full sm:w-auto sm:ml-4"
                    href="about"
                  >
                    Learn more
                  </a>
          ...
          <div>
            ...
            >
              ...
              <button
                className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-none font-medium group p-4 shadow-lg"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
